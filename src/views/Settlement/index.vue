<script setup>
import { getCheckoutInfoAPI, createOrderAPI } from '@/api/settlement'
...
const getChekoutInfo = async () => {
  ...
  curAddress.value = res.result.userAddresses.find((i) => i.isDefault === 0)
  activeAdress.value = curAddress.value
}
